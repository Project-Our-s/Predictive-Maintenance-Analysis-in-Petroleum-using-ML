...
* It uses SCADA.
* Parametrers used Wellhead Pressure (P-TPT)[Pa] , Downhole Pressure (P-PDG)[Pa] , Wellhead Temperature (T-TPT)[C] , Pressure Volatility (Std Dev)[Pa]
* Uses Isolation forest to detect the anomaly.
